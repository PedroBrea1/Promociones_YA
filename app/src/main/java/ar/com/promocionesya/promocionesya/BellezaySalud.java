...
public class BellezaySalud extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bellezay_salud);
        ...
        ArrayAdapter<String> adp = new ArrayAdapter<String>(BellezaySalud.this, android.R.layout.simple_expandable_list_item_1, opciones);
        ...
        menuLateral.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(BellezaySalud.this, opcSeleccionado, Toast.LENGTH_SHORT).show();
