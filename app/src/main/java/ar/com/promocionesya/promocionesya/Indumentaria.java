...
public class Indumentaria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indumentaria);
        ...
        ArrayAdapter<String> adp = new ArrayAdapter<String>(Indumentaria.this, android.R.layout.simple_expandable_list_item_1, opciones);
        ...
        menuLateral.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Indumentaria.this, opcSeleccionado, Toast.LENGTH_SHORT).show();
